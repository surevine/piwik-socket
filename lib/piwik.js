...
Piwik.prototype.track = function(data) {
    console.log('track', data)
}

Piwik.prototype.trackClick = function(data) {
    console.log('trackClick', data)
}

Piwik.prototype.trackGoal = function(data) {
...
Piwik.prototype.trackEvent = function(data) {
